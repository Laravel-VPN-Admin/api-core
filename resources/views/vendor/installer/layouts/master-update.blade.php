...
<head>
  ...
  {{--  <link rel="icon" type="image/png" href="{{ mix('installer/images/favicon-16x16.png') }}" sizes="16x16" />--}}
  {{--  <link rel="icon" type="image/png" href="{{ mix('installer/images/favicon-32x32.png') }}" sizes="32x32" />--}}
  {{--  <link rel="icon" type="image/png" href="{{ mix('installer/images/favicon-96x96.png') }}" sizes="96x96" />--}}
  <link href="{{ mix('css/installer.css') }}" rel="stylesheet" />
  @yield('style')
